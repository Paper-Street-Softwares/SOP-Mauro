...
import { Briefcase, Gavel, Home, Leaf, Scale } from 'lucide-react'
...
export const infos = {
  ...
  phoneSecundario: {
    ddd: '00',
    firstPart: '000000', // Apenas os 5 primeiros números (incluindo o 9)
  ...
  endereco: (
    <div>
      <p>Endereço:</p>
      <p>Av. Leonardo de Carvalho Castelo Branco,</p>
      <p>nº 2835, Sala 12, Bairro São Benedito, </p>
      <p>Parnaíba - PI,</p>
      <p>CEP: 64202-260.</p>
    </div>
  ),
  enderecoSecundario: (
    <div>
      <p>Endereço:</p>
      <p>Rua Monsenhor Bruno, nº 1153,</p>
      <p>Sala 1423, B. Aldeota,</p>
      <p>Centro Empresarial Scopa Platinum Corporate, </p>
      <p>Fortaleza - CE,</p>
      <p>CEP: 60150-161</p>
    </div>
  ),
...
const content = {
  texts: {
    ...
    form: {
      minitag: 'Fale com um advogado',
      title: 'Atendimento direto e sem complicações',
      subtitle:
        'Envie sua mensagem e receba uma orientação inicial clara, com atenção ao seu caso e total sigilo.',
    },
    maps: {
      minitag: 'A_Definir',
      title: 'A_Definir',
